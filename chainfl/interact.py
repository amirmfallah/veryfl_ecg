...
class chainProxy():
    ...
    def get_client_list(self):
        self.client_list = defaultdict(int)
        self.client_list["1"] = 1
        self.client_list["2"] = 2    
        self.client_list["3"] = 3
        self.client_list["4"] = 4   
    ...
    def client_regist(self) -> str:
        ...
        if self.account_num < self.client_num:
            self.add_account()
        new_client_id = str(self.client_num)
        self.client_list[new_client_id] = accounts[self.client_num]
        logger.info(f"Registered new client with ID: {new_client_id}")
